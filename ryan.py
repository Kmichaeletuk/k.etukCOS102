...
class CafeMenuApp:
    def __init__(self, root):
        ...
        self.customer_name_label = tk.Label(root, text="Customer Name:", bg="blue", fg="white")
        ...
        self.menu_label = tk.Label(root, text="Menu:", bg="blue", fg="white")
        ...
        self.item_label = tk.Label(root, text="Item:", bg="blue", fg="white")
        ...
        self.quantity_label = tk.Label(root, text="Quantity:", bg="blue", fg="white")
        ...
        self.add_button = tk.Button(root, text="Add to Order", command=self.add_to_order, bg="orange", fg="white")
        ...
        self.total_label = tk.Label(root, text="Total Charges: ₦0", bg="blue", fg="white")
        self.total_label.grid(row=6, column=0, columnspan=2, padx=10, pady=5, sticky="we")
        
        self.submit_button = tk.Button(root, text="Submit Order", command=self.submit_order, bg="orange", fg="white")
    ...
    def add_to_order(self):
        ...
        tk.Label(self.order_frame, text=order_text, bg="blue", fg="white").pack(anchor="w")
    ...
    def submit_order(self):
        ...
        if not self.order_list:
            messagebox.showinfo("Error", "Please add items to your order!")
            return
        ...
        tk.Label(total_window, text=f"Customer Name: {self.customer_name_entry.get()}", bg="orange", fg="white").pack()
        for item, quantity, price in self.order_list:
            tk.Label(total_window, text=f"{item} (Quantity: {quantity}) - ₦{price}", bg="orange", fg="white").pack()
        tk.Label(total_window, text=f"Total Charges (before discount): ₦{self.total_price}", bg="orange", fg="white").pack()
        tk.Label(total_window, text=f"Discount: {discount*100}%", bg="orange", fg="white").pack()
        tk.Label(total_window, text=f"Total Charges (after discount): ₦{total_price_after_discount}", bg="orange", fg="white").pack()
        
        # Display "ENJOY" on the receipt
        tk.Label(total_window, text="ENJOY", bg="orange", fg="white", font=("Helvetica", 20, "bold")).pack()
